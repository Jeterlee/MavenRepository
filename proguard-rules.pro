...
# https://www.2cto.com/kf/201607/521795.html
#############################################
#
# 对于一些基本指令的添加
#
...
# 不做预校验，preverify 是 proguard的四个步骤之一，Android 不需要 preverify，去掉这一步能够加快混淆速度
-dontpreverify
...
# 移除 Log 类打印各个等级日志的代码，打正式包的时候可以做为禁 log 使用，这里可以作为禁止 log 打印的功能使用
# 记得 proguard-android.txt 中一定不要加 -dontoptimize 才起作用
# 另外的一种实现方案是通过 BuildConfig.DEBUG 的变量来控制
...
#-keep public class com.???.model.entity.** {
#    public void set*(***);
#    public *** get*();
#    public *** is*();
#}
